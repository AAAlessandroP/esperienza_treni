    ...
    con.connect(function (err) {
        ...
        app.post("/new", async (req, res) => {
            ...
            var Giornata = await new Promise((resolve, reject) => {
                con.query(s = `INSERT INTO Giornate (data, Puntualita, Controllore)
                    VALUES ("${req.body.data}", ${req.body.puntualita}, ${req.body.controllo == "on"})`, function (err, result, fields) {
                        if (err) throw err;
            ...
            console.log(req.body.mezzi,req.body.mezzi.length, req.body.mezzi instanceof Array)
            let i=0;
            do {

                if (req.body.mezzi instanceof Array) //se l'user selezione 1 solo tipo di materiale rot nella drop-down list, questa non sarà inviara come array ma come stringa singola
                ...
                switch (element) {
                    ...
                    case "Donizzetti":
                        idMateriale = 7
                        break;
                    default: throw new Error(element)
                        break;
                }
                ...
                console.log(`s`, s);
            } while(req.body.mezzi instanceof Array && i<req.body.mezzi.length);
